...
public partial class FrmCategories : Form
{
    ...
    private void FrmCategories_Load(object sender, EventArgs e)
    {
        ...
        dtGridCategories.DataSource = categoryService.GetAllCategories();
    }
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            int selectedCategoryId = (int)dtGridCategories.CurrentRow.Cells[0].Value;
            CategoryService categoryService = new CategoryService();
    ...
    private void dtGridCategories_CellClick(object sender, DataGridViewCellEventArgs e)
    {
        int selectedCategoryId=(int)dtGridCategories.CurrentRow.Cells[0].Value;
        CategoryService categoryService=new CategoryService();
