...
public partial class NorthwndContext : DbContext
{
    ...
    public virtual DbSet<StorageShipper> StorageShippers { get; set; }
    ...
    public virtual DbSet<TblEgitman> TblEgitmen { get; set; }

    public virtual DbSet<Territory> Territories { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-SPHGMM2D;Database=NORTHWND;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("CategoryControl");
                    tb.HasTrigger("CategoryUpdateControl");
                    tb.HasTrigger("ShowCategoryDetail");
                });
        ...
        modelBuilder.Entity<StorageShipper>(entity =>
        {
            entity.HasKey(e => e.KargoId).HasName("PK__Storage___8E5A959B52F4D2E6");

            entity.ToTable("Storage_Shippers");
        ...
        modelBuilder.Entity<TblEgitman>(entity =>
        {
            entity.HasKey(e => e.EgitmenId);

            entity.Property(e => e.EgitmenId).HasColumnName("EgitmenID");
